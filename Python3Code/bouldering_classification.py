...
RESULT_FNAME = 'bouldering_classification_result.csv'
EXPORT_TREE_PATH = Path('./figures/bouldering_ch7_classification/')
...
try:
    ...
    print('File not found, try to run previous "bouldering" scripts first!')
    raise e
