...
# ----------------- GYROSCOPE DATA ----------------------
            ...
            for k in k_values:
                print(f'k = {k}')
                dataset_cluster = clusteringNH.k_means_over_instances(copy.deepcopy(
                    dataset), ["gyr_X (rad/s)", "gyr_Y (rad/s)", "gyr_Z (rad/s)"], k, 'default', 20, 10)
                silhouette_score = dataset_cluster['silhouette'].mean()
                print(f'silhouette = {silhouette_score}')
                silhouette_values.append(silhouette_score)
            DataViz.plot_xy(x=[k_values], y=[silhouette_values], xlabel='k', ylabel='silhouette score',
...
# ----------------- MAGNETIC FIELD DATA ----------------------
            ...
            if FLAGS.mode == 'kmeans':
                ...
                for k in k_values:
                    print(f'k = {k}')
                    dataset_cluster = clusteringNH.k_means_over_instances(copy.deepcopy(
                        dataset), ["mag_X (µT)", "mag_Y (µT)", "mag_Z (µT)"], k, 'default', 20, 10)
                    silhouette_score = dataset_cluster['silhouette'].mean()
                    print(f'silhouette = {silhouette_score}')
                    silhouette_values.append(silhouette_score)
                DataViz.plot_xy(x=[k_values], y=[silhouette_values], xlabel='k', ylabel='silhouette score',
...
# ----------------- GYROSCOPE DATA ----------------------
        ...
        if FLAGS.mode == 'kmediods':
            ...
            for k in k_values:
                print(f'k = {k}')
                dataset_cluster = clusteringNH.k_medoids_over_instances(copy.deepcopy(
                    dataset), ["gyr_X (rad/s)", "gyr_Y (rad/s)", "gyr_Z (rad/s)"], k, 'default', 20, n_inits=10)
                silhouette_score = dataset_cluster['silhouette'].mean()
                print(f'silhouette = {silhouette_score}')
                silhouette_values.append(silhouette_score)
            DataViz.plot_xy(x=[k_values], y=[silhouette_values], xlabel='k', ylabel='silhouette score',
            ...
            print(f'Highest K-Medoids silhouette score: k = {k}')
            dataset_kmed = clusteringNH.k_medoids_over_instances(copy.deepcopy(dataset), [
                "gyr_X (rad/s)", "gyr_Y (rad/s)", "gyr_Z (rad/s)"], k, 'default', 20, n_inits=50)
            DataViz.plot_clusters_3d(dataset_kmed, ["gyr_X (rad/s)", "gyr_Y (rad/s)", "gyr_Z (rad/s)"], 'cluster',
                                     ['label'],
                                     dataset_name=dataset_name, method='Kmediods')
            DataViz.plot_silhouette(dataset_kmed, 'cluster', 'silhouette', dataset_name=dataset_name, method='Kmediods')
            util.print_latex_statistics_clusters(dataset_kmed, 'cluster', [
                "gyr_X (rad/s)", "gyr_Y (rad/s)", "gyr_Z (rad/s)"], 'label')
...
# ----------------- MAGNETIC FIELD DATA ----------------------
        ...
        if FLAGS.mode == 'kmediods':
            ...
            for k in k_values:
                print(f'k = {k}')
                dataset_cluster = clusteringNH.k_medoids_over_instances(copy.deepcopy(
                    dataset), ["mag_X (µT)", "mag_Y (µT)", "mag_Z (µT)"], k, 'default', 20, n_inits=10)
                silhouette_score = dataset_cluster['silhouette'].mean()
                print(f'silhouette = {silhouette_score}')
                silhouette_values.append(silhouette_score)
            DataViz.plot_xy(x=[k_values], y=[silhouette_values], xlabel='k', ylabel='silhouette score',
            ...
            print(f'Highest K-Medoids silhouette score: k = {k}')
            dataset_kmed = clusteringNH.k_medoids_over_instances(copy.deepcopy(dataset), [
                "mag_X (µT)", "mag_Y (µT)", "mag_Z (µT)"], k, 'default', 20, n_inits=50)
            DataViz.plot_clusters_3d(dataset_kmed, ["mag_X (µT)", "mag_Y (µT)", "mag_Z (µT)"], 'cluster',
                                     ['label'],
                                     dataset_name=dataset_name, method='Kmediods')
            DataViz.plot_silhouette(dataset_kmed, 'cluster', 'silhouette', dataset_name=dataset_name, method='Kmediods')
            util.print_latex_statistics_clusters(dataset_kmed, 'cluster', [
                "mag_X (µT)", "mag_Y (µT)", "mag_Z (µT)"], 'label')
